...
interface IDLTEnumerable is IDLT {
   ...
   */
  function totalSubSupply(uint256 mainId, uint256 subId) external view returns (uint256);
   ...
   */
  function subIdBalanceOf(address owner, uint256 mainId) external view returns (uint256);
}
