...
contract UToken is IUToken, BaseERC20, ReentrancyGuard, UUPSUpgradeable {
   ...
   *
   */
  function totalUnderlyingBalanceNotInvested() public view returns (uint256) {
    return IERC20(_reserve.underlyingAsset).balanceOf(address(this));
    ...
    // ) -
    // IERC20(_reserve.debtTokenAddress).totalSupply();
  }
